...
def main():
    ...
    #记载预训练权重的路径
    model_state_file ="/root/autodl-tmp/pycharm_project_666/_30th_checkpoints_pretrained/best.pt"
    #存放check
    final_output_dir='/root/autodl-tmp/pycharm_project_666/_30th_checkpoints/'
    ...
    # model=attentionUnet.AttU_Net(img_ch=2,output_ch=2)
...
#     #我把第三次实验的checkpoints放在这里
#     #记载预训练权重的路径
#     model_state_file ="/root/autodl-tmp/pycharm_project_666/_25th_checkpoints_pretrained/best.pt"
#     #存放check
#     final_output_dir='/root/autodl-tmp/pycharm_project_666/_25th_checkpoints/'
#     if not os.path.exists(final_output_dir):
#         # 如果不存在，则创建路径
#         os.makedirs(final_output_dir)
